...
```{r}
# model2 <- glm(resp ~ stim_idx + ???, family = binomial(link='logit'), data = data)
# 
# summary(model2)
```
...
Next time, we'll go a bit deeper into the interpretation of logistic regression results, and look at a few more ways of visualizing these data. 
